...
<body
	...
	<div class="w3-bar w3-block" style="padding: 10px">
		...
		<div class="w3-bar-item w3-hover-green">
			<a style="text-decoration: none; color: white;" href="ContactUs.html"><i
				class="fa fa-phone-square" aria-hidden="true"></i> Contact Us </a>
		</div>
		<div class="w3-bar-item w3-hover-green">
			<a style="text-decoration: none; color: white;"
				href="WebCheckIn.html"><i class="fa fa-wifi" aria-hidden="true"></i>
				Web Check-in </a>
		</div>
	</div>
	...
	<div class="col-md-10"
		...
		<form action="AddFlightController" method="POST">
			<h3 style="text-align: center; color: dodgerblue">Add Flight</h3>
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="flightNo">Flight No</label> <input type="text"
						...
						name="flightNo" placeholder="Flight No" autofocus required>
				</div>
				<div class="form-group col-md-6">
					<label for="flightName">Flight Name</label> <input type="text"
						maxlength="20" min="2" class="form-control" id="flightName"
						name="flightName" placeholder="Flight Name" autofocus required>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-4">
					<label for="arrival">Arrival Time</label> <input type="text"
						...
						name="arrival" placeholder="Arrival" required>
				</div>
				<div class="form-group col-md-4">
			...
			<div class="form-group" style="text-align: center; margin-bottom: 0;">
				<button class="btn btn-primary" style="text-decoration: none;" role="button">Add Flight</button>
			</div>
		</form>
	</div>
