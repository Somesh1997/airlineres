...
<body
	...
	<div style="padding-left:80px;">
		...
		<h1 style="color: #0af5e5">Your Upcoming Flights</h1>
		...
		<table class="table table-hover table-borderless table-responsive" style="font-weight: 800">
			...
			<c:forEach var="details" items="${upcoming }">
				<tr>
					...
					<input type="hidden" value="${details.bookingId }" name="bookingid">
					<td class="pl-4"><button type="submit" class="btn btn-sm btn-danger" onclick="return confirmCancel()">Cancel</button></td>
					</form>
				</tr>
			</c:forEach>
			</tbody>
